...
export const TABLES: TableDef[] = [
  ...
  // ── CENTER (south of stage) — tighter rx + wider spacing to avoid seat overlap
  { id: "A", label: "A", seats: 10, x: 37, y: 62, rx: HRX_BACK, ry: HRY },
  { id: "DOCTORS", label: "Doctors", seats: 10, x: 50, y: 62, rx: HRX_BACK, ry: HRY, restricted: true },
  { id: "Q", label: "Q", seats: 10, x: 63, y: 62, rx: HRX_BACK, ry: HRY },
  ...
  // ── RIGHT side — spread out to fix R/O and N/M seat overlap ──────────
  { id: "R", label: "R", seats: 10, x: 70, y: 22, ...V }, // above O
  { id: "O", label: "O", seats: 10, x: 70, y: 42, ...V },
  { id: "N", label: "N", seats: 10, x: 80, y: 38, ...V },
